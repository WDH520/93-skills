...
description: |
  【触发关键词】分析CSV、CSV分析、数据分析、表格分析、
  pandas分析、数据可视化、统计分析、csv analysis、
  data analysis、analyze CSV、pandas、data visualization
  
  【适用场景】当用户需要分析CSV文件、生成统计摘要、
  使用Python和pandas绘制数据可视化图表时使用。
  
  【核心功能】CSV文件分析、统计摘要生成、数据可视化、
  pandas数据处理、图表绘制、数据质量检查。
---
